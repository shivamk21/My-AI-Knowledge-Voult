        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedLinks_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedLinkId = table.Column<Guid>(type: "uuid", nullable: false),
                    TagId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedLinkTags", x => new { x.SavedLinkId, x.TagId });
                    table.ForeignKey(
                        name: "FK_SavedLinkTags_SavedLinks_SavedLinkId",
                        column: x => x.SavedLinkId,
                        principalTable: "SavedLinks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SavedLinkTags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedLinks_CategoryId",
                table: "SavedLinks",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_SavedLinks_Title",
                table: "SavedLinks",
                column: "Title");

            migrationBuilder.CreateIndex(
                name: "IX_SavedLinkTags_TagId",
                table: "SavedLinkTags",
                column: "TagId");
